...
```css
.toc-sublist-item { padding-left: 1rem; }
.toc-sublist .toc-sublist .toc-sublist-item { padding-left: 1.5rem; }
```

## Differentiate top vs nested items

```css
.active-toc-topitem       { color: #38bdf8; }
.active-toc-sublist-item  { color: #a5b4fc; opacity: 1; }
```
...
#toc-item-api-reference.active-toc-item { color: #f59e0b; }
```
...
.dark  .active-toc-item { color: #fef08a; }  /* original default */
.light .active-toc-item { color: #0ea5e9; }
```
